...
class ListProductsByPrice extends React.Component{
    ...
    componentDidMount() {
        ...
        this.listByPrice(minPrice, maxPrice);
    }
    listByPrice(minPrice, maxPrice){
        ProductService.listByPrice(minPrice, maxPrice)
...
export default ListProductsByPrice;