...
class ListProductsByProductType extends React.Component{
    ...
    componentDidMount() {
        ...
        this.listByProductType(productType);
    }
    listByProductType(productType){
        ProductService.getByProductType(productType)
...
export default ListProductsByProductType;